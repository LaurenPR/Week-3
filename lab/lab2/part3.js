...
// console.log(largeStationList); //It worked!

var largeStationCount = _.countBy(data, function(num2) {return num2[3] > 20 ? 'twentyPlus': 'lessOrEqualTwenty' ;});
// console.log(largeStationCount); //It worked!
